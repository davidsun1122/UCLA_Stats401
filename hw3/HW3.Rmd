...
Follow the instructions outlined below to create a cubic basis spline with two knots manually. In a real-world seting, I do not recommend manual creation of basis splines. I recommend using R's spline functions.
...
I will begin by exploring the replationship between `horsepower` and `mpg`. 
