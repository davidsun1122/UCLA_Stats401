...
The summary of the fitted GAM model 4 indicates that 'horsepower' and 'displacement' variables have a significant relationship with `mpg`, but 'weight' and 'acceleration' variables do not have a significant relationship with 'mpg'.
